package com.ld.hellocontentprovider;
...
public class StudentsProvider extends ContentProvider {
	...
	static final String PROVIDER_NAME = "com.ld.provider.College";
	...
	public String getType(Uri uri) {
		switch(uriMatcher.match(uri)){
		case STUDENTS:
			return "vnd.android.cursor.dir/vnd.ld.students";
		case STUDENT_ID:
			return "vnd.android.cursor.item/vnd.ld.students";
		default:
			throw new IllegalArgumentException("Unknow URI "+uri);
		}
	}
